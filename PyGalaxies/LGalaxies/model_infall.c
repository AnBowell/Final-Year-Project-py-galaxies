...
// Not defined in C. SO defined here.
...
const char ReionFuncsDir[50] = "LGalaxies Data Tables/ReionizationFunctions/Mc.txt";
/* reionization Okamoto et al. 2008*/
float Reion_z[46], Reion_Mc[46];



// Read in reionization tables.
